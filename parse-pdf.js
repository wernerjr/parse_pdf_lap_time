// parse-pdf-optimized.js
const fs = require('fs');
const pdfParse = require('pdf-parse');

// Configurações
const pdfPath = 'files/9-25.pdf';
const outputJsonPath = 'pilots.json';

// Função principal para processamento do PDF
